...
- [#30](https://github.com/2wheeh/starskiff/pull/30) [`5096805`](https://github.com/2wheeh/starskiff/commit/5096805b772243a5850de2b65be0347ee2c56637) Thanks [@2wheeh](https://github.com/2wheeh)! - Make `Instance.start()` resolve with `void` instead of a redundant stop
...
- [#31](https://github.com/2wheeh/starskiff/pull/31) [`4387f50`](https://github.com/2wheeh/starskiff/commit/4387f50edd11a0ce57f9b0212f4067dd35b7c2c4) Thanks [@2wheeh](https://github.com/2wheeh)! - Upgrade Cosmos EVM-backed default images to releases patched for GHSA-7g4w-cg88-2cq2: evmd v0.7.2, MANTRA v8.4.0, and XRPL EVM v10.2.0. Pin all three artifacts by immutable manifest digest.
...
- [#32](https://github.com/2wheeh/starskiff/pull/32) [`6ce767a`](https://github.com/2wheeh/starskiff/commit/6ce767ad21c3021c8d850831ed7cc46028cce6af) Thanks [@2wheeh](https://github.com/2wheeh)! - Update the XPLA default to the latest available official GHCR image, v1.11.4. The security-fixed v1.12.0 release image is temporarily unavailable because its upstream container build cannot access a private dependency.
